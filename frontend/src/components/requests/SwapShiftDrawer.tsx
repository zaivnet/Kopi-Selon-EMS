      ...
      <div className="absolute inset-y-0 right-0 flex max-w-full pl-10">
        <div className="w-screen max-w-md bg-white p-6 shadow-2xl dark:bg-slate-900 overflow-y-auto flex flex-col justify-between">
          <div>
            ...
            <div className="mt-5 rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 dark:border-slate-800 dark:bg-slate-950">
            ...
            {selectedPeer && (
              <div className="mt-4 rounded-2xl border border-blue-200 bg-blue-50/60 p-3.5 dark:border-blue-900/40 dark:bg-blue-950/20 text-xs">
